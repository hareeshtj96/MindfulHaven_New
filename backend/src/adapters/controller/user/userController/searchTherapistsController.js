...
exports.default = (dependencies) => {
    ...
    const searchTherapistController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { search } = req.query;
            const response = yield searchTherapistUsecase(dependencies).executeFunction(search);
