...
exports.default = (dependencies) => {
    ...
    const appointmentBookedController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const response = yield getBookedSlotsUsecase(dependencies).executeFunction(id);
