...
exports.default = (dependencies) => {
    ...
    const cancelledBookingController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const response = yield getCancelledBookings(dependencies).executeFunction({ userId, page, limit });
