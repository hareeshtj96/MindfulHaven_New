...
exports.default = (dependencies) => {
    ...
    const getTherapistProfileController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const response = yield getTherapistProfileUsecase(dependencies).executeFunction();
