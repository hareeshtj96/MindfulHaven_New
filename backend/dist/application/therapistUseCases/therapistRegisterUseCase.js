...
exports.default = therapistRegistration;
...
function therapistRegistration(dependencies) {
    ...
    const executionFunction = (data) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const therapistExists = yield therapistRepository.getTherapistByEmail(email);
            if (therapistExists.status) {
                return { status: false, data: httpStatusCode_1.ResponseMessages.THERAPIST_ALREADY_EXISTS };
            }
            const response = yield (0, utils_1.SendOtp)(email);
            if (response.status) {
                const token = jsonwebtoken_1.default.sign({ otp: response.otp, TherapistData: data }, SECRET_KEY, { expiresIn: "10d" });
