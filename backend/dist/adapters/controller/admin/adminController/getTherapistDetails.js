...
exports.default = (dependencies) => {
    ...
    const getTherapistDetailsController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const response = yield therapistDetailstUsecase(dependencies).executeFunction({ therapistId: id });
