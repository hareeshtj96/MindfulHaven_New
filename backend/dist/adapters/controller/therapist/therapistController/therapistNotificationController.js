...
exports.default = (dependencies) => {
    ...
    const therapistNotificationsController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { therapistId } = req.query;
            const response = yield therapistNotificationsUsecase(dependencies).executeFunction({ therapistId });
