...
exports.default = (dependencies) => {
    ...
    const therapistVideoController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const response = yield therapistSessionUsecase(dependencies).executeFunction({ therapistId, bookingId });
