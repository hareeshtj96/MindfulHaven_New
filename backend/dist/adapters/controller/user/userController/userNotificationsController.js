...
exports.default = (dependencies) => {
    ...
    const userNotificationsController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { userId } = req.query;
            const response = yield userNotificationsUsecase(dependencies).executeFunction({ userId });
