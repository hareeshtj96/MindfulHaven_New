...
exports.default = (dependencies) => {
    ...
    const cancelAppointmentController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const response = yield cancelAppointmentUsecase(dependencies).executeFunction({ bookingId, userId });
            ...
            return res.status(httpStatusCode_1.HttpStatusCode.UNAUTHORIZED).json({ status: false, message: httpStatusCode_1.ResponseMessages.INTERNAL_SERVER_ERROR });
        }
    });
