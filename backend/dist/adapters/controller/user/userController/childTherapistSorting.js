...
exports.default = (dependencies) => {
    ...
    const childTherapistSorting = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { sortBy } = req.query;
            const response = yield sortChildTherapistUsecase(dependencies).executeFunction(sortBy);
