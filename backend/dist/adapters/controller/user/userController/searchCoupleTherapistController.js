...
exports.default = (dependencies) => {
    ...
    const searchCoupleTherapistController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { search } = req.query;
            const response = yield searchCoupleTherapistUsecase(dependencies).executeFunction(search);
