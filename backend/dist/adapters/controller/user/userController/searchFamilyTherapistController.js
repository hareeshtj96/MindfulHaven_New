...
exports.default = (dependencies) => {
    const { searchFamilyTherapistUsecase } = dependencies.useCase;
    const searchFamilyTherapistController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { search } = req.query;
            const response = yield searchFamilyTherapistUsecase(dependencies).executeFunction(search);
    ...
    return searchFamilyTherapistController;
};
