...
exports.default = (dependencies) => {
    ...
    const searchIndividualTherapistController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { search } = req.query;
            const response = yield searchIndividualTherapistUsecase(dependencies).executeFunction(search);
