...
exports.default = (dependencies) => {
    ...
    const bookingStatusController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const response = yield bookingDetailstUsecase(dependencies).executeFunction({ bookingId: id });
