...
exports.default = (dependencies) => {
    ...
    const individualTherapistSorting = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { sortBy } = req.query;
            const response = yield sortIndividualTherapistUsecase(dependencies).executeFunction(sortBy);
