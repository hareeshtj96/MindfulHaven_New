...
exports.default = (dependencies) => {
    ...
    const walletDetailsController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { userId } = req.query;
            const response = yield walletDetailsUsecase(dependencies).executeFunction({ userId });
