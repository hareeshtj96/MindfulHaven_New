...
exports.default = (dependencies) => {
    ...
    const searchChildTherapistController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { search } = req.query;
            const response = yield searchChildTherapistUsecase(dependencies).executeFunction(search);
