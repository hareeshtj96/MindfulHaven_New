...
exports.default = (dependencies) => {
    ...
    const checkSlotBeforePaymentController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const slotDate = req.query.slotDate;
            const slotTime = req.query.slotTime;
            const response = yield checkSlotBeforePaymentUsecase(dependencies).executeFunction(id, slotDate, slotTime);
