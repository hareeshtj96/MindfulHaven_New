...
const AdminTherapistDetails = () => {
  ...
  const { selectedTherapist, loading, error } = useSelector(
    ...
    <div className="flex flex-col items-center min-h-screen bg-gray-100">
      <div className="w-full max-w-4xl">
        ...
        <div className="bg-white shadow-md rounded-lg p-6 mb-4">
          ...
          <p className="text-lg mb-4">
            <strong className="pr-2">Specialization:</strong>{" "}
          ...
          <p className="text-lg mb-4">
            <strong className="pr-2">Professional Experience:</strong>{" "}
            {selectedTherapist.professionalExperience} years
          </p>
          <p className="text-lg mb-4">
            <strong className="pr-2">Identity Proof:</strong>
            {selectedTherapist?.identityProof ? (
              <a
                href={selectedTherapist.identityProof}
                target="_blank"
          ...
          <p className="text-lg mb-4">
            <strong className="pr-2">Establishment:</strong>{" "}
            {selectedTherapist.establishment}
          </p>
          <p className="text-lg mb-4">
            <strong className="pr-2">Fees:</strong> ₹{selectedTherapist.fees}
          </p>
          <p className="text-lg mb-4">
            <strong className="pr-2">Counseling Qualification:</strong>{" "}
            {selectedTherapist.counsellingQualification}
          </p>
          <p className="text-lg mb-4">
            <strong className="pr-2">Educational Qualifications:</strong>{" "}
            {selectedTherapist.educationalQualifications}
          </p>
          ...
          <button
            ...
            onClick={() =>
              handleVerify(therapistData._id, therapistData.isVerified)
            }
          >
