...
const BookingStatus = () => {
    ...
    const therapist = useSelector((state: RootState) =>
        state.user.therapists.find(t => t._id === bookingStatus?.therapistId)
    );
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-2xl">
                ...
                <div className="mb-6">
                    ...
                    <div className="bg-gray-100 p-4 rounded-lg shadow-md">
                        <p className="mb-2"><strong>Booking ID:</strong> {bookingStatus?._id || 'N/A'}</p>
                        ...
                        <div className="mb-2">
                        <strong>Time:</strong> {new Date(bookingStatus?.slot).toISOString().split('T')[1].split('.')[0].slice(0, 5) || 'N/A'}
                        </div>

                        <p className="mb-2"><strong>Status:</strong> {bookingStatus?.status || 'N/A'}</p>
                    </div>
                </div>
            </div>
        </div>
